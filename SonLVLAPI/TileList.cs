			...
			switch (Direction)
			{
				case Direction.Horizontal:
					...
					for (int c = stc; c < edc; c++)
						...
						{
							if (i == selectedIndex)
								g.DrawRectangle(new Pen(Color.Magenta, 5), (actualImageWidth * c) - hScrollBar1.Value - 1, actualImageHeight * r - 1, actualImageWidth - 1, actualImageHeight - 1);
				...
				case Direction.Vertical:
					...
					for (int r = str; r < edr; r++)
						...
						{
							if (i == selectedIndex)
								g.DrawRectangle(new Pen(Color.Magenta, 5), actualImageWidth * c - 1, (actualImageHeight * r) - vScrollBar1.Value - 1, actualImageWidth - 1, actualImageHeight - 1);
